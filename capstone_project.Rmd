...
Here, we see that the distribution of response time is right-skewed, but we will fit a Bayesian regression model to obtain the posterior predictive distribution.
